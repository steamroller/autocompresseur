...
int main(int argc,char *argv[])
{
	...
	//int arg = atoi(argv[1]);
	//printf("res = %i\n",arg & 255);
	int tab[17]={12,56,35,120,1,5,12,15,102,103,50,50,156,255,12,15,100};
...
////////
	struct double_tab *main = build_huit(tab,17);
	for(int u = 0; u < 17 ;u++)
	{
		printf("keep n-%i = %i\n",u,*(main->keep));
		main->keep+=1;
	...
	int u = asprintf(&print,"%s%s",print,recup8("test.bin","testb.bin"));
	printf("%s\n",print);
	///////
